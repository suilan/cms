...
{
    public function upload( $form_data, $albumId)
    {

        $validator = Validator::make($form_data, GaleriaImagem::$rules, GaleriaImagem::$messages);
        ...
        $sessionImage = new GaleriaImagem;
        $sessionImage->arquivo   = $allowed_filename;
        $sessionImage->descricao = $originalName;
        $sessionImage->albuns_id  = $albumId;
        $sessionImage->save();
