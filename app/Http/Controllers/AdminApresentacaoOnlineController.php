...
class AdminApresentacaoOnlineController extends Controller {

	public function __construct()
	{
		view()->share('page_title','Apresentação de Títulos Online');
		view()->share('page_description','Edição, criação e exclusão de Apresentação de Títulos Online');
	}
	...
	{	
		$registros = null;
		return view('admin.apresentacaotitulo.home')->with('registros',$registros);
	}
