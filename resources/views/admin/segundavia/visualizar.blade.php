...
<head>
    <title>Intimação Eletrônica de Protesto</title>
...
<body bgcolor="#ffffff">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="666">
        ...
        <tr>
            <th width="666" height="22.8" class="bg border2 center serif" style="padding-top: 5px;"><strong class="biggest">INTIMAÇÃO ELETRÔNICA DE PROTESTO</strong></th>
        </tr>
        <tr>
                            ...
                            <table style="display: inline-table;" border="0" cellpadding="0" cellspacing="0" width="466.2">
                                ...
                                <tr>
                                    <td width="466.2" height="21" class="ph right bottom">
                                        ...
                                        <span class="tr fr">18.360.302/0001-36</span>
                                    </td>
                                </tr>
                                <tr>
